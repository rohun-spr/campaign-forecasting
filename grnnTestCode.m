...
for spread = [0.4, 0.6, 0.8]
    ...
    train_image_name = strcat('images/Train_Plot_Spread_', num2str(spread), '_rsquared_', num2str(rSquaredTrain), '_mse_', num2str(mseTrain), TAG, '.png');
    ...
    test_image_name = strcat('images/Test_Plot_Spread_', num2str(spread), '_rsquared_', num2str(rSquaredTest), '_mse_', num2str(mseTest), TAG, '.png');
